                        ...
                        <div class="form-main-wraper">
                            <div class="registration-form-group">
                                <div class="form-heading ">
                                    <h3>Fill the Details for <em>Registration Candidate</em></h3>
                                </div>
                                <form action="{{ route('admin.candidate-store') }}" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-6">
